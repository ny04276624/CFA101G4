...
<!--                         </div> -->
<!--                         <div class="col-1 text-center"> -->
<%--                         <a href="<%=request.getContextPath()%>/ProductServlet?action=findPD&pid=${pd.p_id}">修改</a> --%>
<!--                         </div> -->
<!--                     </div> -->
<%--                     </c:forEach> --%>
<!--                     已被ajax下拉載入取代			 -->
...
<script type="text/javascript" src="<%=request.getContextPath()%>/JS/Front-end-js/Product-js/selectSelfPD.js"></script>
