                    ...
                    <div class="row m-2 border border-$gray-500 text-center" style="border-radius: 50px;">
                        ...
                        <div class="col-12">
                            <div class="input-group input-group-lg w-50 m-auto">
                                ...
                                <input type="text" value="${productVO.p_id}" name="pid" id="pid" class="form-control" aria-label="Sizing example input"
                        ...
                        <div class="col-12 mt-3">
                            <div class="input-group input-group-lg w-50 m-auto">
                                ...
                                <input type="text" value="${productVO.p_name}" name="pname" id="pname" class="form-control" aria-label="Sizing example input"
                        ...
                        <div class="col-12 mt-3">
                            <div class="input-group input-group-lg w-50 m-auto">
                                ...
                                <select id="pcgid" name="pcgid" class="form-select form-select-lg" aria-label=".form-select-lg example">
                                    <c:forEach var="cs" items="${cs.all }">
                                    <option value="${cs.cg_id}" ${productVO.p_cgid == cs.cg_id ? 'selected' : '' }>${cs.cg_name}
                                    </c:forEach>
                                </select>
                            </div>
                        ...
                        <div class="col-12 mt-3">
                            <div class="input-group input-group-lg w-50 m-auto">
                                ...
                                <input type="text" value="${productVO.p_price}" name="pprice" id="pprice" class="form-control" aria-label="Sizing example input"
                                    aria-describedby="inputGroup-sizing-lg">
                            </div>
                        </div>
                        <div class="col-12 mt-3">
                            <div class="input-group input-group-lg w-50 m-auto">
                                ...
                                <input type="text" value="${productVO.p_stock}" name="pstock" id="pstock" class="form-control" aria-label="Sizing example input"
                                    aria-describedby="inputGroup-sizing-lg">
                            </div>
                        </div>
                        <div class="col-12 mt-3">
                            <div class="input-group input-group-lg w-50 m-auto">
                                ...
                                <textarea class="form-control" name="pdesc" id="pdesc" aria-label="With textarea">${productVO.p_desc}</textarea>
                            </div>
                        </div>
                        <div class="col-12 mt-3">
                            <div class="input-group input-group-lg w-50 m-auto">
                            	<span class="input-group-text" id="inputGroup-sizing-lg">商品狀態</span>
                                	<select id="psta" name="psta" class="form-select form-select-lg" aria-label=".form-select-lg example">
                                    	<option value="0" ${productVO.p_sta == 0 ? 'selected' : '' }>下架中
                                    	<option value="1" ${productVO.p_sta == 1 ? 'selected' : '' }>上架中
                                	</select>
                            </div>
                        </div>
                        <!-- 現有圖片預覽開頭 -->
                                ...
                                <div class="col-2 border border-$gray-500 mt-1" style="border-radius: 20px;margin-left: 5px;">
                                    <div class="col text-end">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="del" value="${img.pi_id}" id="del${img.pi_id}">
                                            <label class="form-check-label" for="del${img.pi_id}">
                                            刪除
                                            </label>
                                          </div>
                                    </div>
                                    <div class="col position-relative border-0">
                                        <img src="data:image/gif;base64, ${pis.out(img.pi_image)}" class="img-thumbnail w-100 h-75 border-0" alt="...">
                                    </div>
                                </div>
                            </c:forEach>
                            </div>
                        ...
                        <div class="col-12 mt-3 mb-3">
                        	<button value="add" name="action" id="add" style="display:none">修改</button>
...
<script type="text/javascript" src="<%=request.getContextPath()%>/JS/Front-end-js/Product-js/findPD.js"></script>
</body>
</html>