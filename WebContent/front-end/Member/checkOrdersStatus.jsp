        ...
        <div class="row  h-100">
          <div class="col-2" style="padding-right: 0px;">
              <div class="col2">
                   ...
                   <div class="col" style="margin-left: 40px; margin-top: 10px;">
                        <div class="col">
                            <a href="/CFA101G4/front-end/Member/storeMoney.html">我的錢包</a>
                        </div>
                   </div>
                   <div class="col" style="margin-left: 40px; margin-top: 10px;">
                        <div class="col">
          ...
          <div class="col-10">
	            ...
	            <div class="col shadow-sm p-3 mb-5 bg-white rounded" style="background-color: white; margin-top: 15px; margin-bottom: 15px!important;">
	                <ul class="nav justify-content-around">
	                    <li class="nav-item">
	                      <a class="nav-link active" aria-current="page" href="/CFA101G4/front-end/Member/checkOrdersStatus.html">全部</a>
	                    </li>
	                    <li class="nav-item">
	                      <a class="nav-link" href="/CFA101G4/front-end/Member/checkOrdersStatus_toBeShipped.html">待出貨</a>
	                    </li>
	                    <li class="nav-item">
	                      <a class="nav-link" href="/CFA101G4/front-end/Member/checkOrdersStatus_waitForReceipt.html" tabindex="-1" aria-disabled="true">待收貨</a>
	                    </li>
	                    <li class="nav-item">
	                        <a class="nav-link" href="/CFA101G4/front-end/Member/checkOrdersStatus_ordersDone.html" tabindex="-1" aria-disabled="true">完成</a>
	                      </li>
	                      <li class="nav-item">
	                        <a class="nav-link" href="/CFA101G4/front-end/Member/checkOrdersStatus_cancelled.html" tabindex="-1" aria-disabled="true">不成立</a>
	                      </li>
	                  </ul>
	            </div>
