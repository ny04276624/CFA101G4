...
<!--                                 <input class="form-check-input" type="checkbox" id="checkbox"> -->
                    ...
                    <c:if test="${od.od_sta == 7 || od.od_sta == 9}">
                    <div class="row justify-content-center p-3">
                        ...
                        <div class="col-3 text-center align-self-center">
                            ...
                            <c:if test="${od.od_goldflow == 1 }">
                             <button type="button" value="${od.od_id }" class="btn btn-danger m-0 disabled">未撥款</button>
                            </c:if>
                            
                            <c:if test="${od.od_goldflow == 3 }">
                            <button type="button" class="btn btn-primary m-0 disabled">已撥款</button>
                            </c:if>
                            
                            
                            <button type="button" value="${od.od_id }" class="btn btn-danger m-0 disabled">評分 ${od.od_point} </button>
                        
                            <!-- Button trigger modal -->
							<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#odcontent${od.od_id}">
							  查看評論
							</button>
							
							<!-- Modal -->
							<div class="modal fade" id="odcontent${od.od_id}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
							  <div class="modal-dialog modal-dialog-centered">
							    <div class="modal-content">
                                  ...
                                  <div class="row">
                                      ...
                                      <div class="col-12 text-center"><i class="bi bi-heart" style="font-size: 25px;">${od.od_point}</i></div>
                                  </div>
                                  <div class="row">
                                    <div class="col-12 mt-3 text-center">
                                        <div class="input-group">
                                            <span class="input-group-text">評論</span>
                                            <textarea class="form-control" aria-label="With textarea" readonly>${od.od_comment}</textarea>
                                          </div>
                                    </div>
                                </div>
                              </div>
