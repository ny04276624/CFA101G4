                ...
                <div class="col">
                    ...
                    <div class="row justify-content-center p-3">
                        ...
                        <div class="col-3 text-center align-self-center">
		                    <button type="button" class="btn btn-primary" id="accept" value="${od.od_id }">接受退貨</button>
		                    <button type="button" value="${od.od_id }" id="refuse" class="btn btn-danger m-0">拒絕退貨</button>
                        </div>
                        <div class="col-2 text-center align-self-center">
...
<script type="text/javascript" src="<%=request.getContextPath()%>/JS/Front-end-js/Product-js/selectReturnOD.js"></script>
