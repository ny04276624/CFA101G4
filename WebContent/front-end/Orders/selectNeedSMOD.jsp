                ...
                <div class="col">
                    <div class="row justify-content-center mt-2">
                        <div class="col text-end ">
                        	<button type="button" value="allupdataOD" id="allshipment" name="action" class="btn btn-primary m-0">一鍵出貨</button>
                    ...
                    <div class="row justify-content-center p-3">
                        ...
                        <div class="col-3 text-center align-self-center">
                            ...
                            <button type="button" id="shipment" value="${od.od_id }" class="btn btn-primary m-0">出貨</button>
                                ...
                                <div class="modal-dialog modal-xl">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            <button type="button" id="modelshipment" value="${od.od_id }" class="btn btn-primary">出貨</button>
