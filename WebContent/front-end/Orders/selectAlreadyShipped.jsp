                ...
                <div class="col">
                    ...
                    <div class="row justify-content-center p-3">
                        ...
                        <div class="col-3 text-center align-self-center">
                        	<button type="button" class="btn btn-danger m-0" id="report" value="${od.od_id }" data-bs-toggle="modal" data-bs-target="#report${od.od_id }">
							  檢舉訂單
							</button>
							<button type="button" id="cancel" value="${od.od_id }" class="btn btn-danger m-0">取消訂單
							</button>
...
<script type="text/javascript" src="<%=request.getContextPath()%>/JS/Front-end-js/Orders-js/selectAlreadyShipped.js"></script>
