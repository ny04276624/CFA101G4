...
<jsp:useBean id="tx" scope="page" class="com.txreport.model.TXReportService" />
...
<!--                          此處留空之後可放搜尋列 -->
                    ...
                    <div class="row justify-content-center p-3">
                        ...
                        <div class="col-3 text-center align-self-center">
		                     ...
		                     <c:if test="${tx.check(od.od_id) == false}">
							<button type="button" class="btn btn-danger m-0" id="cancel" value="${od.od_id }" data-bs-toggle="modal" data-bs-target="#report${od.od_id }">
							  檢舉訂單
							</button>
							</c:if>
							<c:if test="${tx.check(od.od_id)}">
							<button type="button" class="btn btn-danger m-0" id="cancel" value="${od.od_id }" data-bs-toggle="modal" data-bs-target="#report${od.od_id }" disabled>
							 已檢舉
							</button>
							</c:if>
							<form action="<%=request.getContextPath()%>/TXReportServlet" method="post">
							<!-- Modal -->
							<div class="modal fade" id="report${od.od_id }" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
							    ...
							    <div class="modal-content">
							      ...
							      <div class="modal-body">
							      	...
							      	<div class="row">
		                                ...
		                                <input type="text" value="${od.od_id }" name="trodid" id="trodid" class="form-control" aria-label="Sizing example input"
							        ...
							        <div class="row">
		                                ...
		                                <input type="text" value="${od.od_bmemid }" name="trbmemid" id="trbmemid" class="form-control" aria-label="Sizing example input"
		                                    aria-describedby="inputGroup-sizing-lg" readonly>
		                            	</div>
							        	</div>
							        </div>
							        <div class="row h-50">
		                                ...
		                                <textarea class="form-control h-50" name="trcontent" id="trcontent" aria-label="With textarea"></textarea>
		                            	</div>
							        	</div>
							        </div>
							        </div>
							      ...
							      <div class="modal-footer">
							      	<button name="action" value="reportBuy" class="btn btn-danger">送出檢舉</button>
...
<script type="text/javascript" src="<%=request.getContextPath()%>/JS/Front-end-js/Orders-js/selectCancelOD.js"></script>
