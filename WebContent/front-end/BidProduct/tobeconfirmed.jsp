                ...
                <div class="col">
                    <div class="row justify-content-center mt-2">
                        <div class="col text-end ">
                        	<button type="button" value="allupdataOD" id="allshipment" name="action" class="btn btn-primary m-0">一鍵發送通知</button>
                        </div>
                    </div>
                    ...
                    <c:if test="${bid.tobeconfirmed(memberVO.mem_id).size() == 0}">
                    ...
                    <c:forEach var="tobe" items="${bid.tobeconfirmed(memberVO.mem_id)}">
                    <div class="row justify-content-center p-3">
                        <div class="col-2 text-center align-self-center">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="bp_id" value="${tobe.bp_id }" id="bidcheckbox">
                        ...
                        <div class="col-2 text-center align-self-center">
                           <c:if test="${tobe.bp_shsta == 3}">待收貨確認</c:if>
                        </div>
                        <div class="col-2 text-center align-self-center">       
                            <button type="button" id="shipment" value="${tobe.bp_id }" class="btn btn-primary m-0">貨到通知</button>   
                        </div>
