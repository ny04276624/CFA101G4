...
<link rel="icon" href="${pageContext.request.contextPath}/Img/logo1.ico" type="image/x-icon">
<title>天堂鳥討論區</title>
</head>
<body>
	<!-- 導覽列 -->
	<div class="container-fluid" style="padding: 0">
		<nav class="navbar navbar-expand-lg navbar-light bg-dark text-white" id="topbar">
			<div class="container-fluid" style="padding: 0px 8px 0px 8px;">
				...
				<a href="${pageContext.request.contextPath}/front-end/index.jsp"><img src="${pageContext.request.contextPath}/Img/logo.png" alt="" id="logophot"></a> 
		...
		<div class="container" style="padding: 0px;">
			...
			<div class="col" style="margin-top: 5px;">
				<ul class="nav justify-content-center p-2"
					style="border-bottom: 1px solid darkgray; padding-bottom: 5px;"
					id="tablist">
					<li class="nav-item me-4" id="allHotAt"><a class="nav-link active"
						aria-current="page" style="color: rgba(177, 207, 207, 0.808);">熱門文章</a>
					</li>
					<li class="nav-item me-4"  id="allAt"><a class="nav-link" 
						style="color: rgba(177, 207, 207, 0.747);">最新文章</a></li>
					<li class="nav-item"><a class="nav-link"  
						id="qa" style="color: rgba(177, 207, 207, 0.815);">注意事項</a></li>
				</ul>
			</div>
			<!-- 文章區  -->
			<div style="margin-top: 20px;">
				<div class="row row-cols-2 justify-content-around" style="padding: 0px; margin: 0px;" id="art">
					<c:forEach var="articleVO" items="${SomeB}" varStatus="status">
						<div class="card mb-3" id="articletext">
							<div class="row g-0">
								...
								<img src="data:image/png;base64, ${pis.out(articleVO.mempic)}" class="img-fluid" alt="..." style="height:120px;border-radius: 5px;" >
									<div class="USRID"><p>${articleVO.memname}</p>
									</div>
								...
								<div class="col-md-8 shadow p-3 mb-5 bg-body rounded" id="textbox">
									...
									<div class="col" ><button  class="btn btn-secondary" id="colbtn" value="${articleVO.atid}">
										收藏
									</button></div>
									<div class="col" ><button class="btn" id="likeart" value="${articleVO.atid}"><i class="bi-heart-fill" >${articleVO.like}</i></button></div>
									</div>
								</div>
							</div>
						</div>
