...
<link href="/CFA101G4/CSS/Forum-css/RenewMyArticle.css" rel="stylesheet" type="text/CSS">
    ...
    <div class="container" style="margin:50px 0px 80px 100px;">
        <div class="card w-75 p-0" style="height: 810px; margin-left:150px; background-color: white; opacity: 0.88; border-radius: 10px;">
            <div class="card-header ">
                <p class="fs-5 mb-0 text-center">文章修改</p>
            </div>
                    ...
                    <div class="col">
                        <div class="card-body pb-0">
                            <div class="row mt-1 mb-1 ms-0 me-0 p-1 align-items-center" style="border: 1px solid rgb(175, 175, 175); border-radius: 10px;">
                                ...
                                <div class="col">
                                <input type="text" class="form-control border-0" aria-describedby="basic-addon1" value="${artVO.title}" id="atTitle">
                                </div>              
                            </div>
                            <label class="ms-2" id="Titlewarn"></label>
                            <textarea id="mytext" rows="5" cols="30" class="w-100" style="max-height: 550px;">${artVO.text}</textarea>
            ...
            <div class="card-footer text-muted text-center">
                <button type="button" class="btn btn-secondary m-1" id="cancel" onclick="location.href='<%=request.getContextPath()%>/MyArticleServlet'">取消修改</button>
                <button type="button" class="btn btn-secondary m-1" id="RepSubmit" value="${artVO.atid}">提交修改</button>
            </div>
        </div>
    </div>
		...
		<script src="/CFA101G4/JS/Forum-js/RenewMyArticle.js"></script>
