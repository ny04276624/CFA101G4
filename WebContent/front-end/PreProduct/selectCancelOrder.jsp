							...
							<button type="button" class="btn btn-danger m-0"  value="${od.po_id }" data-bs-toggle="modal" data-bs-target="#report${od.po_id }">
							  檢舉訂單
									...
									<form action="/CFA101G4/PrServlet" method="post">
										<!-- Modal -->
										<div class="modal fade" id="report${od.po_id }"
											...
											<div class="modal-dialog modal-lg">
												<div class="modal-content">
																...
																<div class="col m-auto">
																	<div class="input-group input-group-lg m-auto">
																		<span class="input-group-text"
																			id="inputGroup-sizing-lg">檢舉訂單編號</span> <input
																			type="text" value="${od.po_id }" name="PR_POID"
																			id="PR_POID" class="form-control"
															...
															<div class="row">
																<div class="col m-auto">
																	<div class="input-group input-group-lg mt-3">
																		<span class="input-group-text"
																			id="inputGroup-sizing-lg">被檢舉人編號</span> <input
																			type="text" value="${od.po_bmemid }" name="PR_BMEMID"
																			id="PR_BMEMID" class="form-control"
																			aria-label="Sizing example input"
																			aria-describedby="inputGroup-sizing-lg" readonly>
																	</div>
																</div>
															...
															<div class="row h-50">
																<div class="col h-50 m-auto">
																	<div class="input-group input-group-lg h-50 mt-3">
																		...
																		<textarea class="form-control h-50" name="PR_DESC"
																			id="PR_DESC" aria-label="With textarea"></textarea>
																	</div>
																</div>
															</div>
														</div>
													...
													<div class="modal-footer">
														<button name="action" value="reportBuyer"
															class="btn btn-danger">送出檢舉</button>
