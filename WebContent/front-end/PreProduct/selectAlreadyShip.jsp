				...
				<div class="col-2">
					<div class="flex-shrink-0 p-3 bg-white position-sticky top-0">
						<a href="/CFA101G4/front-end/Member/sellCenter.jsp"
                            ...
                            </svg> <span class="fs-5 fw-semibold">賣家中心</span>
						</a>
						<ul class="list-unstyled ps-0">
								...
								<div class="collapse" id="home-collapse">
									<ul class="list-group list-group-flush mt-2">
										<li class="list-group-item border-0"><a
											...
											href="<%=request.getContextPath()%>/front-end/PreProduct/selectSelfPrePd.jsp">商品總覽</a></li>
										<li class="list-group-item border-0"><a
											class="nav-link link-dark p-0"
											href="<%=request.getContextPath()%>/front-end/PreProduct/addPrePd.jsp">新增商品</a></li>
							...
							<li class="mb-1">
								...
								<div class="collapse" id="dashboard-collapse">
									<ul class="list-group list-group-flush mt-2">
										<li class="list-group-item border-0"><a
											class="nav-link link-dark p-0"
											href="/CFA101G4/PoServlet?action=getSellOrder">查看待確認訂單</a></li>
										<li class="list-group-item border-0"><a
											class="nav-link link-dark p-0"
											href="/CFA101G4/front-end/PreProduct/selectCheckShip.jsp">查看待出貨訂單</a></li>
										<li class="list-group-item border-0"><a
											class="nav-link link-dark p-0"
											href="/CFA101G4/front-end/PreProduct/selectCancelOrder.jsp">查看已取消訂單</a></li>
										<li class="list-group-item border-0"><a
											class="nav-link link-dark p-0"
											href="/CFA101G4/front-end/PreProduct/selectAlreadyShip.jsp">查看已出貨訂單</a></li>
										<li class="list-group-item border-0"><a
											class="nav-link link-dark p-0"
											href="/CFA101G4/front-end/PreProduct/selectFinishOrder.jsp">查看已完成訂單</a></li>
							...
							<li class="mb-1">
								<button
									...
									aria-expanded="false">營收相關</button>
							...
							<li class="mb-1">
								<button
									...
									aria-expanded="false">平台規則</button>
				...
				<div class="col">
					<div class="row justify-content-center mt-2">
						<div class="col text-end ">
							<button type="button" value="allupdataOD" id="allAccept"
								name="action" class="btn btn-primary m-0">一鍵接受訂單</button>
						</div>
					</div>
					...
					<div class="row justify-content-center p-3 mt-0">
						<div class="col-2 text-center popover-header">
							<div class="form-check">
								...
								<label class="form-check-label" for="checkbox"> 訂單編號 </label>
							</div>
						</div>
						<div class="col-1 text-center popover-header">買家編號</div>
						<div class="col-2 text-center popover-header">下單時間</div>
						<div class="col-2 text-center popover-header">訂單總額</div>
						<div class="col-3 text-center popover-header">操作</div>
						<div class="col-2 text-center popover-header">更多</div>
					</div>
					<!-- 訂單的開頭預設結束點 -->
					<!-- 一張訂單的起始點 -->
					...
					<c:forEach var="od" items="${os.allSorder(memberVO.mem_id) }">
						<c:if test="${od.po_sta == 4 }">
							<div class="row justify-content-center p-3">
								<div class="col-2 text-center align-self-center">
									<div class="form-check">
										<input class="form-check-input" type="checkbox" name="odid"
											value="${od.po_id}" id="odidcheckbox"> <label
                        	...
                        	<button type="button" class="btn btn-danger m-0"  value="${od.po_id }" data-bs-toggle="modal" data-bs-target="#report${od.po_id }">
							  檢舉訂單
							</button>
							<button type="button" id="cancel" value="${od.po_id }" class="btn btn-danger m-0">取消訂單
							</button>
							
							
							<!-- form表單 填寫檢舉資訊 -->
							<form action="/CFA101G4/PrServlet" method="post">
							<!-- Modal -->
							<div class="modal fade" id="report${od.po_id }" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
							    ...
							    <div class="modal-content">
							      ...
							      <div class="modal-body">
							      	...
							      	<div class="row">
		                                ...
		                                <input type="text" value="${od.po_id }" name="PR_POID" id="PR_POID" class="form-control" aria-label="Sizing example input"
							        ...
							        <div class="row">
		                                ...
		                                <input type="text" value="${od.po_bmemid }" name="PR_BMEMID" id="PR_BMEMID" class="form-control" aria-label="Sizing example input"
		                                    aria-describedby="inputGroup-sizing-lg" readonly>
		                            	</div>
							        	</div>
							        </div>
							        <div class="row h-50">
		                                ...
		                                <textarea class="form-control h-50" name="PR_DESC" id="PR_DESC" aria-label="With textarea"></textarea>
		                            	</div>
							        	</div>
							        </div>
							        </div>
							      ...
							      <div class="modal-footer">
							      	<button name="action" value="reportBuyer" class="btn btn-danger">送出檢舉</button>
							        <input type="button" class="btn btn-secondary" value="取消" data-bs-dismiss="modal">
							      </div>
							    </div>
							  </div>
							</div>
							<!-- Modal結尾 -->
								...
								<div class="col-2 text-center align-self-center">
									...
									<button type="button" class="btn btn-secondary"
										data-bs-toggle="modal" data-bs-target="#bmemid${od.po_id}">查看訂單詳情</button>
									<!-- Modal -->

									<div class="modal fade" id="bmemid${od.po_id }"
										...
										<div class="modal-dialog modal-xl">
											<div class="modal-content">
												<div class="modal-header">
													<h5 class="modal-title" id="staticBackdropLabel">買家
														${od.po_bmemid } 的訂單明細</h5>
												...
												<div class="modal-body">
													<div class="container-fluid">
														...
														<div class="row">
															<div class="col-2 text-center popover-header">商品編號
															</div>

															<div class="col-2 text-center popover-header">商品名稱
															</div>
															<div class="col-2 text-center popover-header">買家名稱
															</div>
															<div class="col-2 text-center popover-header">買家電話
															</div>
															<div class="col-2 text-center popover-header">數量</div>
															<div class="col-2 text-center popover-header">金額</div>
														</div>
														<!-- 訂單內明細商品的起始點 -->
														...
														<div class="row">
															...
															<div class="col-2 text-center align-self-center">
																${ps.getOnePd(od.po_pdid).pd_name }</div>
															<div class="col-2 text-center align-self-center">
																${od.po_bname }</div>
															<div class="col-2 text-center align-self-center">
																${od.po_tel }</div>
...
<!--     尾巴結尾 -->
	...
	<script type="text/javascript"
		src="/CFA101G4/JS/Front-end-js/Preproduct-js/selectAlreadyShip.js"></script>
	<script
