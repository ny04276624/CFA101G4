                ...
                <div class="col">
                    ...
                    <div class="row justify-content-center p-3">
                        ...
                        <div class="col-3 text-center align-self-center">
                            ...
                            <button type="button" id="shipment" value="${od.po_id}" class="btn btn-primary m-0">出貨</button>
...
<script type="text/javascript" src="/CFA101G4/JS/Front-end-js/Preproduct-js/selectCheckShip.js"></script>
