            ...
            <div class="row">
                ...
                <div class="col">
                    ...
                    <div class="row justify-content-center p-3">
                        ...
                        <div class="col-1 text-center align-self-center">
                            <c:if test="${od.po_goldflow == 1 }">
                             <button type="button"  class="btn btn-danger m-0 disabled">待撥款</button>
                            </c:if>
                            <c:if test="${od.po_goldflow == 3 }">
                             <button type="button"  class="btn btn-danger m-0 disabled">已撥款</button>
                            </c:if>
                        ...
                        <div class="col-2 text-center align-self-center">
                       		...
                       		<c:if test="${od.po_iscom == 0 }">
                       		
                       		<button type="button"  class="btn btn-danger m-0 disabled">尚未評分</button>
                       		
                       		</c:if>
                       		<c:if test="${od.po_iscom == 1}">
                            <button type="button" value="${od.po_id }" class="btn btn-danger m-0 disabled">評分 ${od.po_point} </button>
                        	
                            <!-- Button trigger modal -->
							<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#odcontent${od.po_id}">
							  查看評論
							</button>
							
							</c:if>
							<!-- Modal -->
							<div class="modal fade" id="odcontent${od.po_id}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
							  <div class="modal-dialog modal-dialog-centered">
							    <div class="modal-content">
							      <div class="modal-header">
							        <h5 class="modal-title" id="staticBackdropLabel">訂單評論</h5>
							        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
							      </div>
							      <div class="modal-body">
							        <div class="container-fluid">
                                  <div class="row">
                                      <div class="col-12 text-center">此筆訂單評分為</div>
                                      <div class="col-12 text-center"><i class="bi bi-heart" style="font-size: 25px;">${od.po_point}</i></div>
                                  </div>
                                  <div class="row">
                                    <div class="col-12 mt-3 text-center">
                                        <div class="input-group">
                                            <span class="input-group-text">評論</span>
                                            <textarea class="form-control" aria-label="With textarea" readonly>${od.po_comment}</textarea>
                                          </div>
                                    </div>
                                </div>
                              </div>
...
<script type="text/javascript" src="/CFA101G4/JS/Front-end-js/Preproduct-js/selectFinshCheckShip.js"></script>
