                ...
                <div class="row m-2 border border-$gray-500 text-center" style="border-radius: 50px;">
                    ...
                    <div class="col-12">
                        <div class="input-group input-group-lg w-50 m-auto">
                            ...
                            <input type="text" name="PD_NAME" id="PD_NAME" class="form-control" aria-label="Sizing example input"
                        ...
                        <div class="input-group input-group-lg w-50 m-auto">
                            ...
                            <select name="PD_PCID" id="PD_PCID" class="form-select form-select-lg" aria-label=".form-select-lg example">
                                ...
                                <c:forEach var="pcVO" items="${pcSvc.all}">
										<option value="${pcVO.pc_id}" ${(pdVO.pd_pcid==pcVO.pc_id)? 'selected':'' } >${pcVO.pc_desc}
								</c:forEach>
                            </select>
                        </div>
                    ...
                    <div class="col-12 mt-3">
                        <div class="input-group input-group-lg w-50 m-auto">
                            ...
                            <input type="text" name="PD_PRICE" id="PD_PRICE" class="form-control" aria-label="Sizing example input"
                                aria-describedby="inputGroup-sizing-lg" placeholder="請填寫數字">
                        </div>
                    </div>
                    <div class="col-12 mt-3">
                        <div class="input-group input-group-lg w-50 m-auto">
                            <span  class="input-group-text" id="inputGroup-sizing-lg">成團數量</span>
                            <input type="text" name="PD_NO" id="PD_NO" class="form-control" aria-label="Sizing example input"
                                aria-describedby="inputGroup-sizing-lg" placeholder="請填寫數字">
                        </div>
    				...
    				<div class="col-12 mt-3">
                        <div class="input-group input-group-lg w-50 m-auto">
                            <span class="input-group-text" id="inputGroup-sizing-lg">預購開始日</span>
                            <input type="text" name="PD_SDATE" id="PD_SDATE" class="form-control" aria-label="Sizing example input"
                                aria-describedby="inputGroup-sizing-lg">
                        </div>
                    </div>
					...
					<div class="col-12 mt-3">
                        <div class="input-group input-group-lg w-50 m-auto">
                            <span class="input-group-text" id="inputGroup-sizing-lg">預購結束日</span>
                            <input type="text" name="PD_EDATE" id="PD_EDATE" class="form-control" aria-label="Sizing example input"
                                aria-describedby="inputGroup-sizing-lg">
                        </div>
                    </div>
                    ...
                    <!--預計出貨日 -->
					 <div class="col-12 mt-3">
                        <div class="input-group input-group-lg w-50 m-auto">
                            <span class="input-group-text" id="inputGroup-sizing-lg">預計出貨日</span>
                            <input type="text" name="PD_SPDATE" id="PD_SPDATE" class="form-control" aria-label="Sizing example input"
                                aria-describedby="inputGroup-sizing-lg">
                        </div>
                    </div>
                    ...
                    <div class="col-12 mt-3">
                        <div class="input-group input-group-lg w-50 m-auto">
                            ...
                            <textarea class="form-control" name="PD_DESC" id="PD_DESC" aria-label="With textarea"></textarea>
                        </div>
                    </div>
...
<script type="text/javascript" src="/CFA101G4/JS/Front-end-js/Preproduct-js/addPrePd.js"></script>
...
$(function(){
	 $('#PD_SDATE').datetimepicker({
	  format:'Y-m-d H:i:s',
	  onShow:function(){
	   this.setOptions({
	    maxDate:$('#PD_EDATE').val()?$('PD_EDATE').val():false
	   })
	  },
	  timepicker:true,
	  step: 1
	 ...
	 $('#PD_EDATE').datetimepicker({
	  format:'Y-m-d H:i:s',
	  onShow:function(){
	   this.setOptions({
	    minDate:$('#PD_SDATE').val()?$('#PD_SDATE').val():false
	   })
	  },
	  timepicker:true,
	  step: 1
	 ...
	 $('#PD_SPDATE').datetimepicker({
		  format:'Y-m-d H:i:s',
		  onShow:function(){
		   this.setOptions({
		    minDate:$('#PD_EDATE').val()?$('#PD_EDATE').val():false
		   })
		  },
		  timepicker:true,
		  step: 1
