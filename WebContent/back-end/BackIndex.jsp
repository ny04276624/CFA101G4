  ...
  <div class="container-fluid">
    ...
    <div class="row">
      ...
      <div class="col-10" id="LNbody">
        ...
        <!-- 每一列的開頭 -->
		<div class="col-12 mt-3"><p class="h1 text-center">管理員首頁</p></div>
    <div class="col-12 mt-3"><p class="h3 text-center">您好～請選擇功能</p></div>
    <div class="col-12 mt-3">
      <div class="row">
    <div class="col text-center">
      <img src="<%=request.getContextPath()%>/Img/all.png" class="img-thumbnail w-50" alt="...">
      </div>
      </div>
    </div>
        <!-- 每一列的結尾 -->
