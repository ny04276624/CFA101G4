$.ajax({
                ...
                <div id="goods-${key}">
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-6 text-end">
                                 ...
                                 <button type="button" class="btn btn-danger btn-sm"  data-ref="${obj[key][0].ordersVO.od_id}" id="refund-${key}">申請退貨</button>
                            
                            
                                 <button type="button" style="margin-right:58px;" class="btn btn-outline-success btn-sm"  data-con="${obj[key][0].ordersVO.od_id}" id="confirm-${key}">確認收貨</button>
    ...
    error:function(data){
        alert("有誤！")
            ...
            //退貨訂單 將狀態改成4
            $("#ajaxchange").on("click", "[data-ref]",function(e){
                swal({
                    title: `確定要申請退貨訂單${e.target.dataset.ref}嗎？`,
                    text: '此舉有可能影響您的信用評分！',
                    type: 'warning',
        ...
        $("#ajaxchange").on("click", "[data-con]",function(e){
            swal({
                title: `您即將完成此筆訂單！`,
                text: '請進行訂單資訊的最終確認...',
                type: 'warning',
