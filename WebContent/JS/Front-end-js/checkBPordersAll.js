        ...
        success: function (data) {
            ...
            for (let i = 0; i < data.length; i++) {
                ...
                if(data[i].bp_shsta == 1 ){
                    btn=`
                    <button type="button" class="btn btn-secondary">填寫收貨資訊</button>
                    <button type="button" class="btn btn-secondary">取消訂單</button>
                    `
                }


                if(data[i].bp_shsta == 2 ){
                    btn=`
                    <button type="button" class="btn btn-secondary">取消訂單</button>
                    `
                }
                ...
                // 這個要留著 裡面包含評論的視窗
                if(data[i].bp_shsta == 3)
                btn=`
                <button type="button" class="btn btn-secondary">確認收貨</button>
                <button type="button" class="btn btn-secondary">申請退貨</button>
